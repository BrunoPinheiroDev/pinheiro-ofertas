 ...
 * Versão: Alinhamento Nativo com Ícone de Raio para PIX
 */
get_header(); 
?>
    ...
    <div class="oferta-box-wrapper">
        <div class="oferta-hero">
            ...
            <div class="oferta-info-col">
                ...
                <a href="<?php echo esc_url($link); ?>" target="_blank" class="btn-pegar">IR PARA A LOJA ➔</a>

                <a href="<?php echo $link_zap; ?>" target="_blank" class="btn-whatsapp">
